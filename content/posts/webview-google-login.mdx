...
date: "2025-01-20"
tags: ["frontend", "webview", "vue", "oauth", "google-login", "android"]
...
const onErrorHandler = (errorResponse) => {
  ...
  // 팝업 차단 또는 닫힘 감지
  if (errorResponse.type === 'popup_closed' || errorResponse.type === 'popup_failed_to_open') {
    alert('popup_blocked')
    return
  }
...
*   **Google Sign-In for Web**: [Google Identity Services](https://developers.google.com/identity/gsi/web)
*   **OAuth 2.0 Authorization Code Flow**: [RFC 6749, Section 1.3.1](https://www.rfc-editor.org/rfc/rfc6749#section-1.3.1)
...
*   **Android WebView**: [Build web apps in WebView](https://developer.android.com/develop/ui/views/webview)
*   **JavaScript Interface**: [WebView addJavascriptInterface](https://developer.android.com/develop/ui/views/webview/evaluate-javascript)
*   **Chrome Custom Tabs**: [Chrome Custom Tabs Overview](https://developer.chrome.com/docs/android/custom-tabs/overview/)

### 보안 및 인코딩

*   **URL Encoding**: [MDN - encodeURIComponent()](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/encodeURIComponent)
*   **PKCE (OAuth 보안 강화)**: [RFC 7636 - Proof Key for Code Exchange](https://www.rfc-editor.org/rfc/rfc7636)

### Vue 3 & Pinia

*   **Vue 3 Composition API**: [Vue.js Official Guide](https://vuejs.org/guide/extras/composition-api-faq.html)
*   **Pinia**: [Getting Started with Pinia](https://pinia.vuejs.org/getting-started.html)
