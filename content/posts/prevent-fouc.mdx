---
title: SSR 환경에서 SCSS Mixin으로 플리커링 해결하기
description: "JavaScript 기반 반응형 로직을 SCSS Mixin으로 전환하여 SSR 환경에서 발생하는 플리커링(FOUC) 문제를 근본적으로 해결한 사례를 공유합니다."
date: "2025-01-05"
tags: ["ssr", "scss", "vue", "css", "frontend"]
slug: "ssr-flickering-scss-mixin"
