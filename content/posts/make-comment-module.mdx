...
description: "A사 댓글 모듈 종료에 대응하여, 프레임워크 독립적인 Vanilla JS 댓글 모듈을 설계·개발하고 기존에 서비스 중이던 Nuxt 3 프로젝트에 통합한 과정을 공유합니다."
date: "2026-01-30"
...
<table>
  ...
  <tbody>
    <tr>
      <td>공지사항 상세</td>
      <td>bManager 옵션으로 작성자 표시</td>
    </tr>
    <tr>
      <td>이벤트 상세</td>
      <td>allowedComment 플래그</td>
    </tr>
    <tr>
      <td>프로모션 페이지</td>
      <td>특이사항 없음</td>
