...
이전 포스트 [Nuxt 3 프로젝트에서 서브도메인 처리하기](https://velog.io/@swj9077/Nuxt-3-%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8%EC%97%90%EC%84%9C-%EC%84%9C%EB%B8%8C%EB%8F%84%EB%A9%94%EC%9D%B8-%EC%B2%98%EB%A6%AC%ED%95%98%EA%B8%B0)에서 서브도메인을 처리하는 방법을 정리했습니다. 이번 포스트에서는 해당 코드 구조를 기반으로 URL로 다국어 처리를 하는 방법을 정리해보겠습니다.
